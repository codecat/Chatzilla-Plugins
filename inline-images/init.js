...
{
	client.munger.addRule("inline-images", new RegExp("(http://([a-z0-9\\-]+\\.)+([a-z]{2,})([A-Za-z0-9\\_\\-/]*)[A-Za-z0-9\\_\\-]{5,}.(jpg|png|gif|bmp))"), function(matchText, containerTag, eventData, mungerEntry){
