...
{
	client.munger.addRule("f7u12",  /(\[(troll|fu|megusta|milk|perfect|harpdarp|fuckthatshit|wtf|challengeaccepted|wayevil|yuno|fuckyeah|awman|okay|melvin|omg|lol|yup|foreveralone|gtfo|ohno|jackie|sweetjesus|awyea|foreveralonelaugh|actually|pickletime|pokerface|sadtroll|disappoint|stare|seriously|badpokerface|trolldad|omfg|dude|heh|meep|megustaperfect|angered|betterthanexpected|fff|hmm|sad|argh)\])/, function(matchText, containerTag, eventData){
